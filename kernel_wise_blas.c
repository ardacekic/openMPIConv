...
void im2col(const int input_tensor[INPUT_HEIGHT][INPUT_WIDTH][INPUT_CHANNELS], float *col_matrix, int output_height, int output_width) {
    int col_idx = 0;
...
void kernel_wise_convolution(int rank, int num_procs) {
    ...
    int col_size = INPUT_CHANNELS * KERNEL_HEIGHT * KERNEL_WIDTH * output_height * output_width;
    ...
    im2col(input_tensor[0], col_matrix, output_height, output_width);
