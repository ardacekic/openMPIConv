...
def plot_all_execution_times(channel_sizes, kernel_sizes, np_values, ch_kernel_collections):
    ...
    plt.title("Blas Optimized Kernel-Channel Wise and Simple Convolution Configurations ")
    ...
    for kernel_size in kernel_sizes:
        for np_value in np_values:
            ...
            for _ in range(100):
                ...
                os.system(f"mpicc -O3 -o kernel_conv.o kernel_wise_blas_im2col_optimized.c -I/usr/include/x86_64-linux-gnu/openblas64-pthread -L/usr/lib/x86_64-linux-gnu/openblas64-pthread -lopenblas64 && mpirun --allow-run-as-root --use-hwthread-cpus -np {np_value} ./kernel_conv.o")
